...
- **Run ID:** `2026-03-01_1757_warwick_campus_system4kw_load3200_v2`
- **Created (local):** `2026-03-01T17:57:19`
- **PVGIS source:** `downloaded:raw_warwick_campus_2019_lat52p384_lonm1p5615_tilt20_az225.csv`
- **Tariff mode:** `compare`
...
- PV generation: 3,863.3 kWh
- Load: 3,200.0 kWh
- Self-consumed PV: 1,194.5 kWh (30.9% of PV)
- Energy sent to grid: 2,668.8 kWh
- Energy bought from grid: 2,005.5 kWh
- Self-sufficiency: 37.3% of load met by PV

## Finance summary (from finance model)

- Annual savings (Tariff A): £734.79
- Annual savings (Tariff B): £693.98
- Payback (Tariff A): 10.0
- Payback (Tariff B): 10.0
- Net Present Value (NPV) (Tariff A): £813.30
- Net Present Value (NPV) (Tariff B): £392.17
- ROI (Tariff A): 63.4%
- ROI (Tariff B): 53.3%
...
- Savings (Tariff A): £734.79
- Savings (Tariff B): £693.98
