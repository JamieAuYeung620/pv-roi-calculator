...
- **Run ID:** `2026-03-01_1756_warwick_campus_system4kw_load3200_v2`
- **Created (local):** `2026-03-01T17:56:39`
- **PVGIS source:** `downloaded:raw_warwick_campus_2020_lat52p384_lonm1p5615_tilt20_az225.csv`
- **Tariff mode:** `compare`
...
- PV generation: 4,054.6 kWh
- Load: 3,200.0 kWh
- Self-consumed PV: 1,188.3 kWh (29.3% of PV)
- Energy sent to grid: 2,866.3 kWh
- Energy bought from grid: 2,011.7 kWh
- Self-sufficiency: 37.1% of load met by PV

## Finance summary (from finance model)

- Annual savings (Tariff A): £762.67
- Annual savings (Tariff B): £721.86
- Payback (Tariff A): 9.0
- Payback (Tariff B): 10.0
- Net Present Value (NPV) (Tariff A): £1,093.99
- Net Present Value (NPV) (Tariff B): £672.91
- ROI (Tariff A): 70.2%
- ROI (Tariff B): 60.0%
...
- Savings (Tariff A): £762.67
- Savings (Tariff B): £721.86
