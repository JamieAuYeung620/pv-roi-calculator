...
- **Run ID:** `2026-03-01_1602_warwick_campus_system4kw_load3200_v3`
- **Created (local):** `2026-03-01T16:02:45`
- **PVGIS source:** `downloaded:raw_warwick_campus_2020_lat52p384_lonm1p5615_tilt0_az45.csv`
- **Tariff mode:** `compare`
...
- Savings (Tariff A): £717.33
- Savings (Tariff B): £674.57
