...
- **Run ID:** `2026-03-01_1756_warwick_campus_system4kw_load3200`
- **Created (local):** `2026-03-01T17:56:17`
- **PVGIS source:** `downloaded:raw_warwick_campus_2020_lat52p384_lonm1p5615_tilt40_az315.csv`
- **Tariff mode:** `compare`
...
- PV generation: 2,658.8 kWh
- Load: 3,200.0 kWh
- Self-consumed PV: 1,110.9 kWh (41.8% of PV)
- Energy sent to grid: 1,547.9 kWh
- Energy bought from grid: 2,089.1 kWh
- Self-sufficiency: 34.7% of load met by PV

## Finance summary (from finance model)

- Annual savings (Tariff A): £543.23
- Annual savings (Tariff B): £507.11
- Payback (Tariff A): 13.0
- Payback (Tariff B): 14.0
- Net Present Value (NPV) (Tariff A): £-1,122.73
- Net Present Value (NPV) (Tariff B): £-1,493.29
- ROI (Tariff A): 17.0%
- ROI (Tariff B): 8.1%
...
- Savings (Tariff A): £543.23
- Savings (Tariff B): £507.11
