...
- **Run ID:** `2026-03-01_1947_warwick_campus_system4kw_load3200`
- **Created (local):** `2026-03-01T19:47:05`
- **PVGIS source:** `downloaded:raw_warwick_campus_2017_lat52p384_lonm1p5615_tilt0_az180.csv`
- **Tariff mode:** `compare`
...
- PV generation: 3,438.1 kWh
- Load: 3,200.0 kWh
- Self-consumed PV: 1,162.5 kWh (33.8% of PV)
- Energy sent to grid: 2,275.6 kWh
- Energy bought from grid: 2,037.5 kWh
- Self-sufficiency: 36.3% of load met by PV

## Finance summary (from finance model)

- Annual savings (Tariff A): £666.84
- Annual savings (Tariff B): £624.54
- Payback (Tariff A): 11.0
- Payback (Tariff B): 11.0
- Net Present Value (NPV) (Tariff A): £127.67
- Net Present Value (NPV) (Tariff B): £-309.59
- ROI (Tariff A): 47.0%
- ROI (Tariff B): 36.5%
...
- Savings (Tariff A): £666.84
- Savings (Tariff B): £624.54
