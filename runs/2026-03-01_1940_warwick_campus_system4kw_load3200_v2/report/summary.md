...
- **Run ID:** `2026-03-01_1940_warwick_campus_system4kw_load3200_v2`
- **Created (local):** `2026-03-01T19:40:46`
- **PVGIS source:** `downloaded:raw_warwick_campus_2007_lat52p384_lonm1p5615_tilt0_az180.csv`
- **Tariff mode:** `compare`
...
- PV generation: 3,618.6 kWh
- Load: 3,200.0 kWh
- Self-consumed PV: 1,202.1 kWh (33.2% of PV)
- Energy sent to grid: 2,416.5 kWh
- Energy bought from grid: 1,997.9 kWh
- Self-sufficiency: 37.6% of load met by PV

## Finance summary (from finance model)

- Annual savings (Tariff A): £699.07
- Annual savings (Tariff B): £656.11
- Payback (Tariff A): 10.0
- Payback (Tariff B): 11.0
- Net Present Value (NPV) (Tariff A): £454.07
- Net Present Value (NPV) (Tariff B): £10.15
- ROI (Tariff A): 54.8%
- ROI (Tariff B): 44.1%
...
- Savings (Tariff A): £699.07
- Savings (Tariff B): £656.11
