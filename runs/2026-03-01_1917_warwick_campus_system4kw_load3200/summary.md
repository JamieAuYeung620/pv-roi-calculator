...
- **Run ID:** `2026-03-01_1917_warwick_campus_system4kw_load3200`
- **Created (local):** `2026-03-01T19:17:33`
- **PVGIS source:** `downloaded:raw_warwick_campus_2005_lat52p384_lonm1p5615_tilt30_az45.csv`
...
- PV generation: 2,568.7 kWh
- Load: 3,200.0 kWh
- Self-consumed PV: 1,097.3 kWh (42.7% of PV)
- Energy sent to grid: 1,471.4 kWh
- Energy bought from grid: 2,102.7 kWh
- Self-sufficiency: 34.3% of load met by PV
...
- Savings (Tariff A): £527.96
- Savings (Tariff B): £488.42
