...
- **Run ID:** `2026-02-26_1535_warwick_campus_system4kw_load3200_v2`
- **Created (local):** `2026-02-26T15:35:35`
...
- **Mode:** `custom`
- **Requested:** `2020-08-01` to `2020-10-31` (inclusive)
- **Used (after clamping):** `2020-08-01` to `2020-10-31` (inclusive)
...
- Window: **2020-08-01 to 2020-10-31**
- PV generation: 902.1 kWh
- Load: 751.7 kWh
- Self-consumed PV: 305.6 kWh (33.9% of PV)
- Exported PV: 596.5 kWh
- Grid import: 446.2 kWh
- Self-sufficiency: 40.6% of load met by PV

### Period bill (Tariff A vs B)

- Savings (Tariff A): £175.03
- Savings (Tariff B): £163.64
