...
- **Run ID:** `2026-02-17_1837_warwick_campus_system4kw_load3200_v10`
- **Created (local):** `2026-02-17T18:37:06`
- **PVGIS source:** `downloaded:raw_warwick_campus_2015_lat52p384_lonm1p5615.csv`
- **Tariff mode:** `A`
...
- PV generation: 3,435.4 kWh
- Load: 3,200.0 kWh
- Self-consumed PV: 1,203.0 kWh (35.0% of PV)
- Exported PV: 2,232.4 kWh
- Grid import: 1,997.0 kWh
- Self-sufficiency: 37.6% of load met by PV

## Finance summary (from finance model)

- Annual savings: £671.70
- Payback: 11.0
- NPV: £2,262.20
- ROI: 141.6%
