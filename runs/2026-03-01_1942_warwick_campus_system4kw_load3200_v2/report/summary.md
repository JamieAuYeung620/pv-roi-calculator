...
- **Run ID:** `2026-03-01_1942_warwick_campus_system4kw_load3200_v2`
- **Created (local):** `2026-03-01T19:42:56`
- **PVGIS source:** `downloaded:raw_warwick_campus_2008_lat52p384_lonm1p5615_tilt0_az180.csv`
- **Tariff mode:** `compare`
...
- PV generation: 3,418.3 kWh
- Load: 3,200.0 kWh
- Self-consumed PV: 1,162.3 kWh (34.0% of PV)
- Energy sent to grid: 2,256.0 kWh
- Energy bought from grid: 2,037.7 kWh
- Self-sufficiency: 36.3% of load met by PV

## Finance summary (from finance model)

- Annual savings (Tariff A): £663.85
- Annual savings (Tariff B): £621.45
- Payback (Tariff A): 11.0
- Payback (Tariff B): 11.0
- Net Present Value (NPV) (Tariff A): £97.30
- Net Present Value (NPV) (Tariff B): £-340.98
- ROI (Tariff A): 46.3%
- ROI (Tariff B): 35.7%
...
- Savings (Tariff A): £663.85
- Savings (Tariff B): £621.45
