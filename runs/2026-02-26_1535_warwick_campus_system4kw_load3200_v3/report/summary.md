...
- **Run ID:** `2026-02-26_1535_warwick_campus_system4kw_load3200_v3`
- **Created (local):** `2026-02-26T15:35:54`
...
- **Mode:** `custom`
- **Requested:** `2020-04-07` to `2020-10-31` (inclusive)
- **Used (after clamping):** `2020-04-07` to `2020-10-31` (inclusive)
...
- Window: **2020-04-07 to 2020-10-31**
- PV generation: 2,960.1 kWh
- Load: 1,669.5 kWh
- Self-consumed PV: 828.3 kWh (28.0% of PV)
- Exported PV: 2,131.9 kWh
- Grid import: 841.3 kWh
- Self-sufficiency: 49.6% of load met by PV

### Period bill (Tariff A vs B)

- Savings (Tariff A): £551.69
- Savings (Tariff B): £526.30
