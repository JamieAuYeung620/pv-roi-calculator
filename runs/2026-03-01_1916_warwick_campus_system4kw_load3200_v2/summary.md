...
- **Run ID:** `2026-03-01_1916_warwick_campus_system4kw_load3200_v2`
- **Created (local):** `2026-03-01T19:16:30`
- **PVGIS source:** `downloaded:raw_warwick_campus_2005_lat52p384_lonm1p5615_tilt30_az225.csv`
- **Tariff mode:** `compare`
...
- PV generation: 3,897.7 kWh
- Load: 3,200.0 kWh
- Self-consumed PV: 1,172.9 kWh (30.1% of PV)
- Energy sent to grid: 2,724.7 kWh
- Energy bought from grid: 2,027.1 kWh
- Self-sufficiency: 36.7% of load met by PV

## Finance summary (from finance model)

- Annual savings (Tariff A): £737.13
- Annual savings (Tariff B): £700.66
- Payback (Tariff A): 10.0
- Payback (Tariff B): 10.0
- Net Present Value (NPV) (Tariff A): £835.56
- Net Present Value (NPV) (Tariff B): £459.82
- ROI (Tariff A): 64.0%
- ROI (Tariff B): 54.9%
...
- Savings (Tariff A): £737.13
- Savings (Tariff B): £700.66
